...
import InspectorDashSideber from './InspectorDashSideber';
...
const InspectorDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        <InspectorDashSideber activeTab={activeTab} setActiveTab={setActiveTab} isMobileMenuOpen={isMobileMenuOpen} />
