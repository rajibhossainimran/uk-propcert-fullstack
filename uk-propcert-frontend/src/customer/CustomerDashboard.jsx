          ...
          <nav className="space-y-2">
            <button
              className={`w-full flex items-center space-x-2 p-2 rounded-lg ${
                activeTab === 'dashboard' ? 'bg-lime-100 text-lime-700' : 'text-gray-600 hover:bg-gray-100'
              }`}
            ...
            <button
              className={`w-full flex items-center space-x-2 p-2 rounded-lg ${
                activeTab === 'documents' ? 'bg-lime-100 text-lime-700' : 'text-gray-600 hover:bg-gray-100'
              }`}
            ...
            <button
              className={`w-full flex items-center space-x-2 p-2 rounded-lg ${
                activeTab === 'settings' ? 'bg-lime-100 text-lime-700' : 'text-gray-600 hover:bg-gray-100'
              }`}
            ...
            <Link to='/'
              className={`w-full flex items-center space-x-2 p-2 rounded-lg ${
                activeTab === 'home' ? 'bg-lime-100 text-lime-700' : 'text-gray-600 hover:bg-gray-100'
              }`}
